...
export default class PersonList extends React.Component {
    ...
    componentDidMount() {
        axios.get(`https://rocky-gorge-97831.herokuapp.com/cekilis/cards`)
            .then(res => {
        ...
        return (
            ...
            <View style={{ flex:1,  backgroundColor: '#F1F1F1' }}>
                ...
                <SafeAreaView style={{ flex: 1, backgroundColor: '#F1F1F1' }}>
                    <ScrollView>
                        <View style={{ backgroundColor: 'pink', textAlign: 'center', justifyContent: 'center', alignItems: 'center', marginBottom:60 }}>
                            <Text style={{ paddingTop: 15, color: 'white', justifyContent: 'center', alignItems: 'center', textAlign: 'center', marginBottom:20 }}> Anasayfada ekibimiz tarafindan en cok begenilmis 10 cekilis gosterilmektedir</Text>
